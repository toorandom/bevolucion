...
/*
 * Imprime toda la poblacion con ciertas caracteristicas referentes al cromosoma referencia y gen referencia
 */
void muestra_poblacion (celula * poblacion, uint16_t habitantes, int16_t cromo_ref,int16_t gen_ref, gen gen_elite);
